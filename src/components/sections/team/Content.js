...
import img2 from '../../../assets/img/team/6.jpeg';
import img3 from '../../../assets/img/team/1.jpg';
import img4 from '../../../assets/img/team/6.jpeg';
import img5 from '../../../assets/img/team/2.jpeg';
const teamgridposts = [
    { img: img1, name: 'Rosa D.William', designation: 'Founder & CEO' },
    { img: img2, name: 'hilixer b. browni', designation: 'co-founder' },
    { img: img3, name: 'pokoloko k. kilix', designation: 'consultant' },
    { img: img4, name: 'pokoloko k. kilix', designation: 'consultant' },
    { img: img5, name: 'pokoloko k. kilix', designation: 'consultant' },
    { img: img1, name: 'Rosa D.William', designation: 'Founder & CEO' },
];
            ...
            <section className="team-section has-slider pt-115 pb-115">
                <div className="container">
                    <div className="section-title text-center mb-80">
                        ...
                        <span className="title-tag">Our Team</span>
                        <h2>Talent We Rely On</h2>
                    </div>
                    <div className="row team-loop">
                        {teamgridposts.map((item, i) => (
                            <div key={i} className="col-lg-4 col-md-6">
                                <div className="member-box">
                                    ...
                                    {/* <Link to="#" className="socail-trigger">
